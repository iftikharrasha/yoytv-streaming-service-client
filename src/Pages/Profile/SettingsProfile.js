              ...
              <div className="browse__contents__form__right">
                <form action="">
                  ...
                  <div className="single">
                    ...
                    <p>
                      Mostrar títulos de todas las clasificaciones en este
                      perfil
                    </p>
                  ...
                  <div className="single border-0 mb-0">
                    ...
                    <ul className="terms">
                      <li>
                        ...
                        />
                        <label for="term1">
                          Reproducir automáticamente el siguiente episodio de
                          una serie en todos los dispositivos conectados.
                        </label>
                      </li>
                      <li>
                        <input
                        ...
                        />
                        <label for="term2">
                          Se reproducen automáticamente los avances mientras
                          navegas en todos los dispositivos conectados.
                        </label>
                      </li>
                    </ul>
                  </div>
