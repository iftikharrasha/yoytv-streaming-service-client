...
const Registration = () => {
    ...
    const [cardData, setCardData] = useState({ id: '', token: '', sub_profile_id: '', subscription_id: '', payment_mode: '', cardNo: '', cvv: '', month: '', year: '', login_by: 'manual', device_type: 'web', device_token: 123456});
    ...
    const register = async (e) => {
        ...
        if(response.success){
            setError('');
            setSuccess(true);
            setCardData({ ...cardData, id: response.data.id, sub_profile_id: response.data.sub_profile_id, subscription_id: response.data.sub_profile_id, token: response.data.token })
        }
    }
                    ...
                    <div className="registration__form">
                        <div className="registration__form__contents">
                            ...
                            <Form>
                                ...
                                <button type="submit" className="main-btn secondary" onClick={(e) => register(e)}>Registrarme</button>
                            </Form>
                        </div>
                    </div> : 
                    <div className="registration__form">
                            ...
                            <Form>
                                <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
                                    ...
                                    <div key={`inline-${type}`} className="mb-3">
                                        <Form.Check
                                            ...
                                            autoComplete="off"
                                            value="card"
                                            onClick={(e) => setCardData({ ...cardData, payment_mode: e.target.value })}
                                        />
                                        <Form.Check
                                            inline
                                            label="Crédito"
                                ...
                                <Form.Group className="mb-4" controlId="exampleForm.ControlInput2">
                                    ...
                                    <Form.Control
                                        ...
                                        onChange={(e) => setCardData({ ...cardData, cardNo: e.target.value })}
                                        autoComplete="off"
                                    />
                                </Form.Group>
                                <Form.Group className="mb-4" controlId="exampleForm.ControlInput4">
                                    ...
                                    <div className="select__group">
                                        <div className="single__dropdown">
                                            <select onChange={(e) => setCardData({ ...cardData, month: e.target.value })}>
                                        ...
                                        <div className="single__dropdown">
                                            <select onChange={(e) => setCardData({ ...cardData, year: e.target.value })}>
                                ...
                                <div className="reg__button">
                                    ...
                                    <button type="submit" className="main-btn secondary" onClick={(e) => cardAdd(e)}>Pagar</button>
                                </div>
                            </Form>
                        </div>
                    </div>
