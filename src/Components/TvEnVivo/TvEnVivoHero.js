...
const TvEnVivoHero = ({nowPlaying}) => {
    ...
    return (
        <>
            <section className="hero onDemandHero tvEnVivo__player">
                <div className="heroFixed">
                    <div className="hero__slider">
                        <div className="heroBg hero__slider__single" style={{backgroundImage: `url(${image})`}}>
                            <div className="heroBg__contents">
                                <div className="heroBg__contents__text">
                                    <h1>{title}</h1>
                                    <h2>{description}</h2>
                                    <h4>{hours}h {minutes}m<span>{Rated}</span>
                                    </h4>
                                    <ul>
                                        <li>
            ...
            <TvModal show={show} setShow={setShow} video={video}/>
        </>
    );
};
